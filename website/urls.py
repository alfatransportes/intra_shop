...
urlpatterns = [
    ...
    path("pix/<int:pk>/comprovante/", views_checkout.enviar_comprovante_pix, name="enviar_comprovante_pix"),
    path("compras/", views_checkout.minhas_compras, name="minhas_compras"),
    path("pedido/<int:pk>/", views_checkout.venda_detalhe, name="venda_detalhe"),
    path("pedido/<int:pk>/rastrear-json/", views_checkout.rastrear_encomenda_json, name="rastrear_encomenda_json"),
    path("favoritar/<int:produto_id>/", views.favorito_toggle, name="favorito_toggle"),
