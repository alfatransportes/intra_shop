...
from .views import (FormaPagamentoCreateView, FormaPagamentoDeleteView,
                    ...
                    ProdutoExportXlsxView, ProdutoImportTemplateDownloadView,
                    ProdutoImportView, ProdutoListView, ProdutoManageView,
...
urlpatterns = [
    ...
    path("painel-controle/vendas/nova/", VendaManageView.as_view(), name="dashboard_venda_create"),
    path("painel-controle/vendas/<int:pk>/editar/", VendaManageView.as_view(), name="dashboard_venda_update"),
